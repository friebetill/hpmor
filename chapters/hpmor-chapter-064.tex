...
\wrapchapter{Omake Files IV,}{Alternate Parallels}

\vspace{-1cm}
\begin{center}
    \scriptsize\hp
    \MakeUppercase{The other fanfictions you could've been reading}
\end{center}
\vspace{1cm}

\omakeFourTitle{\omakeFourFontTextLotR}{1.6}
...
\omakeFourTitle{\omakeFourFontTextWardrobe}{5}
...
don't know if it's enough to beat{\el} \emph{her.}"
...
this tremendous battle where he killed the White Witch{\el}"
...
rule over.}
\sbreak
\omakeFourLogo{.8}{TheVillageHidden}
...
\omakeFourTitle{\MakeUppercase{Erdős in Chains}}{1.5}
...
\omakeFourTitle{\omakeFourFontTextThunder}{2}
...
\sbreak
\vfil\pagebreak
\omakeFourLogo{.7}{TheNameOfTheRationality}
