...
warning signs of a major Dark Wizard. \mbox{Everyone} was talking about it, wondering
...
you twice as much classroom time as Doubles sessions\mbox{---}"
...
"Ah, Professor Quirrell\mbox{---}" Harry started to say.
...
attack the enemy is an \emph{ordinary} use, of course\mbox{---}"
...
hang someone, or Draco Malfoy's robes, which can be used to start a fire\mbox{---}"
