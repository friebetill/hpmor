...
\emph{(Be prepared, as through life you march along{\el})}
...
---hissed, \parsel{"Hungry, boy? Eat your fill sswiftly, we sshall need both\linebreak{}
sstrength and time."}
...
The Defense Professor{\el} was an ambiguous figure, to put it mildly; Harry
...
taught Harry how to lose{\el} if the Defense Professor wanted to make some
...
they were taking were literally the most stringent possible{\el}
...
The food vanished from the table, the chairs leapt back into place, the door
sprang open.
...
guessed this answer fully a week ago. It needed only a slight adjustment{\el}
...
"Without telling me yet{\el}" said Harry. "Can you say if the need is
desperate?"
