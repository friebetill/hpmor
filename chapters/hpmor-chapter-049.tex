...
suspected since December, in fact\mbox{---}"
...
class, to find out what happened with the Sorting Hat\mbox{---}"
...
Parselmouth. Professor, \emph{what} the sweet slithering snakes\mbox{---}"
...
Monster was \emph{not} to rid \mbox{Hogwarts} of Muggleborns. Unless Slytherin's
...
a way to bypass the Interdict of \mbox{Merlin}.
...
"Avada Kedavra," said Harry, suddenly feeling sick to his \mbox{stomach}.
...
bring hourglasss to move through time\mbox{---}"}

\parsel{"You know?"} hissed Harry in shock. \parsel{"How\mbox{---}"}
...
down enemy with pie, two ballss of memory\mbox{---}"}
...
whatever thiss iss, you have not ssaid\mbox{---}"}

The snake performed a shiver that Harry's mind translated as a severe glare.
\parsel{"Of coursse not. Will disscusss sspecificss at next \mbox{meeting}."}
\looseness=1
