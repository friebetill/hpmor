\wrapchapter{Something to Protect:}{Albus Dumbledore}
...
stepped aside. "I'm sorry, Mr.~Potter, I was delayed\mbox{---}"
...
Harry still wasn't sure{\el} wasn't sure at \emph{all}, what Hermione would
...
he couldn't imagine what Hermione \emph{would} think{\el}
...
glance, and then pointed his wand directly at Harry and said "\emph{Avada Kedavra.}"
...
who'd regained her poise. "We are still waiting on Director Crouch\mbox{---}"
...
It leapt up and flew across the table, into Harry's hand. And the moment that
...
anyway. "Voldemort had{\el} rather a lot of Horcruxes, actually. So instead
...
\vspace{-\baselineskip}% Compensate for double spacing of \sbreak and writtenNote
\begin{writtenNote}
...
During the First Wizarding War, there came a time when I realized that
...
world{\el} no, make it even more local, what do I have to do} today{\el}
\emph{besides figuring out what to do, that is, and I'd better not delay before
looking at whatever Dumbledore left me in the Phoenix's Egg room{\el}}
...
cooperation would be invaluable, maybe \emph{necessary,} for{\el} for
...
"Um," Harry said. "You{\el} don't think very much of Dumbledore, I take it?"

"I thought{\el}" said the old witch. "Well. Albus Dumbledore was a better
...
away from his eyes. "I think{\el} I'm beginning to realize{\el}
Dumbledore was the only sane person, in all of this, all along. The \emph{only}
one who was doing the right things for anything like the right reasons{\el}"
...
to learn me, trust me{\el} and instead it was all over in an evening." Harry
inhaled. "Can't you just \emph{pretend} we've been fighting Voldemort for years
and I earned your trust and everything? So that I'm not penalized for winning
...
the Stone, change myself to look like ninety{\el}}
...
Harry's eyes were a bit wide, listening to all this. "Um{\el} what exactly
...
more of a problem." Harry sighed. "And you, Madam Bones{\el} er. Sorry if
...
Merlin is just about being Chief Warlock. There's, um. I suspect{\el} that
there's weird other stuff that goes along with it. And that Dumbledore meant me
to take responsibility for the{\el} other stuff. And that the other stuff
is{\el} possibly quite \emph{amazingly} important."
...
said, still calmly. "If they test you as you were tested before the Wizengamot?
...
could{\el} prove politically controversial, and in exchange for handing over
the Line's political power to Madam Bones I'm going to want her{\el} um,
...
\emph{Slight, slight the dark tinge{\el}} "I don't have an alternative to
...
time. I'm not going to pull Merlin's name on you, but{\el} no, strike that,
...
actually{\el} "So," Harry said. "Any weirdness for me that you would have
brought to Dumbledore while he was around?"

Amelia looked thoughtful. "Since you ask{\el} I can think of three things,
...
Aurors, but still{\el} "I think this is a matter you don't need to
...
a possibility that Augustus Rookwood left a ghost\mbox{---}"
...
"Bellatrix," Harry said. His mind had leapt back, made the connection that
...
"What \emph{idiot}\mbox{---}" Harry stopped himself. "No, \emph{not} an idiot. Because
immediately destroying Dark objects is Department policy. Because of past
experiences with rings that really should've been dropped into volcanoes
immediately. Right?"

Moody and Amelia nodded in unison. "Good guess, son," said Moody.

It might seem inevitable, from a literary standpoint,
that Harry's past stupidity was going to
...
matter{\el} there was one truly puzzling element to last night's events, and
...
"Ah{\el}" said Minerva. "That's not possible even by You-Know-Who's
...
knew old Pollux would demand it{\el} nah, ain't buyin' it."
...
"Yes, in fact{\el}" Minerva said slowly. "Why?"
...
"You\mbox{---}" whispered Amelia Bones. "You should not try to be this person, at your
age\mbox{---}"
...
"I," said Amelia. The old witch seemed bent, diminished. "I{\el} do not
think, that even with this{\el} scandal, that the remainder of the
Wizengamot will bend{\el} and the Dementors must be fed, not so much as we
have fed them, but they must be given some victims, or they will roam the
world, prey on innocents{\el}"

"It doesn't matter what the Wizengamot says," Harry said. "Because\mbox{---}" Harry's
voice choked. "Because\mbox{---}" Harry took a deep breath, steadied himself. He
...
"An authorized Portkey to Azkaban would be appreciated\mbox{---}" Harry's voice broke
...
"Though I think, she might make, her own way there{\el}"
...
"Fourth\mbox{---}" Harry said, and then stopped.
...
With six billion Muggles thinking creatively about how to use magic{\el}
