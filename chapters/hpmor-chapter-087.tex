...
around to scan the library. (There was one boy in a \mbox{distant} corner, who did
...
Richard Feynman, and Douglas \mbox{Hofstadter}."
\looseness=1
...
basket, or a bundle, with a dozen live cats in it, and\mbox{---}"
...
to \emph{feel} inside\mbox{---}" Harry put a hand over his own heart, in the
...
it was fun to hurt his enemies\mbox{---}"
\looseness=1
...
one who does it. Everyone knows that\mbox{---}"
...
often keep quiet about projects they're \mbox{working} on. You and I are doing
...
Harry Potter's breathing was starting to scale up toward \mbox{hyperventilation}.
...
"I mean---I'm not saying \emph{I'm} in love with \emph{you,} but\mbox{---}"
...
misunderstand, I'm sure you're a wonderful person\mbox{---}"

She took a staggering step back.

"---but---even with my dark side\mbox{---}"

"Is \emph{that} what this is about?" said Hermione. "But I---I would not\mbox{---}"

"No, no, I mean, I have a mysterious dark side and probably other weird magic
stuff going on, you \emph{know} I'm not a normal child, not really\mbox{---}"

"It's okay to not be normal," she said, feeling increasingly desperate and
confused. "\emph{I'm} okay with it\mbox{---}"
...
a higher probability to you than anyone else I can think of\mbox{---}"
...
considering how many people end up horribly unhappy in \mbox{traditional} marriages,
it seems like it might be the sort of thing that needs some clever
reworking---especially if we actually do solve immortality\mbox{---}"
\sbreak
