...
you'll---get \emph{older,} you'll age faster\mbox{---}" \emph{Like Albus.}
...
work of ssome other power\mbox{---}"}
...
watcherss ssee Dark Lord explode\mbox{---}"}
...
thiss time, will enumerate risskss and benefitss firsst\mbox{---}"}
