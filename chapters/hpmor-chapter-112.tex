...
\glqq{}Nein, Meister!\grqq{}, rief die maskierte Gestalt. \glqq{}Wir wussten, Ihr
würdet zurückkehren - aber, aber wir konnten Dumbledore nicht ohne euch
bekämpfen -"

\glqq{}\textbf{Crucio}." Ein furchtbarer Schrei entrang sich der Maske, er
...
Potter gerichtet. Lüg mich nicht noch einmal an.}"
...
Gast auf meiner Wiedergeburtsfeier ist.}"
...
diesen sogenannten Jungen-der-lebte töten kann!"
...
provozieren, damit ich einen Fehler wiederhole?}" Lord Voldemort schwebte und
...
Ihr mir nur für kurze Zeit erlaubt -"
...
ist niemand anderes als Hermine Granger} -"

\glqq{}Was?\grqq{}, rief einer der Schwarzgekleideten, und dann: \glqq{}Es tut mir
leid, Meister, es tut mir leid, ich bitte Euch -"

\glqq{}\textbf{Crucio}." Dieser Schrei dauerte nur ein paar Sekunden, und
...
anderen Umständen - selbst wenn sie entkommen würde.}" Ein kaltes, hohes Lachen,
...
Ein kaltes, hohes Lachen. \glqq{}\textbf{Ah, Mr. White, der straffälligste meiner
...
Herrscher von Britannien erklären!}"

Die versammelten Masken atmeten tief durch, aber eine Gestalt lachte.

\glqq{}\textbf{Du findest mich amüsant, Mr. Grim?}"
...
würde, könntest du ihm vertrauen?}"
...
könntest du dann seinen Worten vertrauen? Antworte mir!}" Voldemorts Stimme
erhob sich zu einem Schrei.

\glqq{}Ich ... ja, Meister, ich nehme an, ich würde ..."
...
dafür nötig sein ...}" Voldemort lächelte sein schreckliches Lächeln. \glqq{}
\textbf{Mr. White wird es tun.}"

\glqq{}Nein, bitte! Meister, ich flehe Euch an! Ich habe Euch besser gedient als
jeder andere - so gut ich konnte -"
...
versucht zu fliehen, auch wenn das bedeutet, dass ihr andere Todesser trefft.}"
...
\textbf{Habt ihr das verstanden, Mr. Grim, Mr. White? Wir haben es mit einer
...
\glqq{}Ich denke, Meister, dass es mir wiederholt werden muss."
...
\glqq{}Ja, Meister\grqq{}, kam der vierunddreißigfache Refrain.
...
\glqq{}.\textbf{..so soll es sein}\grqq{}, sagte die kalte, präzise Stimme von
Lord Voldemort.
...
\glqq{}\textbf{Hat der Schwur gewirkt, Mr. White?}"

Mr. White klang, als ob er weinen würde. \glqq{}Ja, Meister... ich habe so viel
verloren, bitte, ich bin schon genug bestraft worden."
...
\glqq{}\textbf{Besser. Jetzt werden wir den Jungen-der-lebte töten.}"

Mr. White taumelte. Mr. Grim lachte wieder, und auch die anderen lachten.

\glqq{}\textbf{Ich habe das nicht getan, um lustig zu sein\grqq{}} , sagte
...
Dann zischte Voldemort: \glqq{}\textbf{\emph{Es wurde prophezeit, dass du Macht
...
\emph{Wird keine brauchbare Lösung eingereicht, endet die Geschichte traurig und
kürzer.} \emph{Beachtet Folgende Einschränkungen: 1. Harry muss es aus eigener
Kraft schaffen. Die Kavallerie wird nicht kommen. Jeder, der Harry helfen
möchte, denkt, er sei bei einem Quidditch-Spiel.

2. Harry darf nur Fähigkeiten einsetzen, die ihm die Geschichte bereits gezeigt
hat; er kann nicht in den nächsten 60 Sekunden wortlose Legilimenz entwickeln.

3. Voldemort ist böse und kann nicht dazu überredet werden, gut zu sein; die
Nutzenfunktion des Charkaters des Dunklen Lords als Antagonist kann nicht
verändert werden, indem man mit ihm spricht.

4. Wenn Harry seinen Zauberstab erhebt oder in etwas anderem als Parsel spricht,
werden die Todesser sofort auf ihn schießen.

5. Wenn die einfachste Zeitlinie sonst eine ist, in der Harry stirbt - wenn
Harry seinen Zeitumkehrer nicht ohne die Hilfe des Zeitumkehrer erreichen kann -
dann kommt der Zeitumkehrer nicht ins Spiel.

6. Es ist unmöglich in Parsel Lügen zu erzählen.

Innerhalb dieser Einschränkungen ist es Harry erlaubt, sein volles Potenzial als
Rationalist zu erreichen, jetzt in diesem Moment oder nie, unabhängig von seinen
früheren Fehlern.

Natürlich ist \glqq{}die rationale Lösung\grqq{}, wenn man das Wort \glqq{}
rational\grqq{} richtig verwendet, nur eine unnötig ausgefallene Art zu sagen
\glqq{}die beste Lösung\grqq{} oder \glqq{}die Lösung, die ich mag\grqq{} oder
\glqq{}die Lösung, die ich denke, dass wir verwenden sollten\grqq{}, und man
sollte normalerweise stattdessen einen der letzteren Begriffe sagen.

(Wir brauchen das Wort 'rational' nur, um über Denkweisen zu sprechen, die
unabhängig von bestimmten Lösungen betrachtet werden.)

Und nach dem Vinge-Prinzip gilt: Wenn man genau weiß, was ein kluger Kopf tun
würde, muss man selbst mindestens so klug sein. Jemanden zu fragen \glqq{}Was
würde ein optimaler Spieler für den besten Zug halten?\grqq{} sollte keine
bessere Antwort hervorbringen als \glqq{}Was denkst du ist der beste Zug?\grqq{}
Was ich also in der Praxis meine, wenn ich sage, dass Harry sein volles
Potenzial als Rationalist ausschöpfen darf, ist, dass Harry dieses Problem so
lösen darf, wie DU es lösen würdest.

Wenn du mir genau sagen kannst, wie ich etwas tun soll, dann ist es Harry
erlaubt, daran zu denken. Aber es dient nicht als Lösung, wenn man z. B. sagt:
\glqq{}Harry sollte Voldemort überreden, ihn aus der Falle zu lassen\grqq{}, wenn
man selbst nicht herausfinden kann, wie.

Ich erinnere euch nochmals daran, dass ihr Stunden zum Nachdenken habt. Nutzt
die \glqq{}Keine Lösungen vorschlagen\grqq{} Technik.}

\emph{Und ganz ehrlich, ich meine es ernst, Harry kann in den nächsten 60
