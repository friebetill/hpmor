...
you need someone with you\mbox{---}"
...
I'll do that too, I promise I'll never let magic come between us\mbox{---}"
...
the ground, leading somewhere that doesn't seem to make sense\mbox{---}"
...
"I, um\mbox{---}" Harry swallowed. "Look, we don't have time for this now\mbox{---}"
...
Hogwarts? Ron's new, too\mbox{---}" and then she peered closely at him. "\emph{Harry
Potter?}"
...
not to bother you with until now\mbox{---}"
...
"Okay, Mister Spoo\mbox{---}" Ron stopped. "I can't do that, it makes me feel stupid."
...
"Um, maybe fifteen or twenty in professional games\mbox{---}"
...
first is going to be mostly luck\mbox{---}"
...
the Snitchless Reformation and nail it to a church door\mbox{---}"
...
"Anyway, Potter{\el} if you really were raised by Muggles\mbox{---}" Draco paused
...
have come in while \emph{you} were flattering \emph{me}\mbox{---}" Draco laughed. "But
...
"Ouch," Harry said, wincing. "I'm \emph{really} sorry\mbox{---}"
...
put on my disguise again, I \emph{really} don't want to deal with\mbox{---}"
...
charmed to vanish just a few seconds later\mbox{---}" Indeed the stain on his beard
...
costume? Something unexpected is bound to happen\mbox{---}"
...
a lot more upset about someone killing a child\mbox{---}"
...
"Yep. I can owe you a favor for it\mbox{---}"
...
the boy. "\emph{Go} to the---it's just a\mbox{---}" His finger pointed at the little
