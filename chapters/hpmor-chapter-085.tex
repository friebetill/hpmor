...
\emph{Was bedeutete, dass Knut Haukelid unschuldige Menschen getötet hatte.
...
\emph{Nein, ich habe es nicht so
gemeint, bitte stirb nicht!}   <p
style=\grqq{}.ext-align:center\grqq{}.\emph{Nein, ich wollte das nicht, bitte
stirb nicht!}    \emph{Nimm es mir
nicht weg, bitte nicht -}
...
\textbf{Los geht's. Es ist an der Zeit.
}
