...
"\emph{Zahav} is gold?" Harry questioned, and Professor McGonagall nodded.
...
knowledge, and it's not using \emph{my} knowledge\mbox{---}" Harry waved a hand
...
hands sternly on his hips. "I am not going to be in Gryffindor\mbox{---}"
...
\emph{What\el\kern\ellipsisgapitalic?}
...
"I---I didn't mean to\mbox{---}" The inference dropped like a falling stone into
...
to\mbox{---}" and then Harry shut his lips and slapped a hand over his mouth for good
measure.
...
Christmas---Madam Pomfrey won't be there, I'll need a healer's kit of my own\mbox{---}"
...
attack the whole school to get at me. But on a happier note\mbox{---}"
...
"\emph{Della!}" said Professor McGonagall, sounding scandalized.
...
with that\mbox{---}" Harry stopped short.
...
come up with new reasons not to change his mind\mbox{---}" Harry stopped. "I'm too
...
staring at his wand. He'd waved it, and produced multicolored sparks, which
...
Harry was a bit skeptical of that "\emph{no one} has \emph{ever} escaped from
...
lose and the loser shall win\mbox{---}"

Professor McGonagall's head swiveled, and her eyes darted around, as though to
...
"Mr.~Potter, you shouldn't go inventing things to worry about\mbox{---}"
...
\emph{invented} such a signal if you didn't know about\mbox{---}"
...
and her eyes narrowed and the witch bit out, "\emph{Where} did you get that\mbox{---}"
...
name for that\el\kern\ellipsisgapitalic? The Death Eater Eaters?}

"I'll see you again soon, when school starts," Professor McGonagall said. "And,
Mr.~Potter, about your wand\mbox{---}"
