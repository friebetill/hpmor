...
"Are you\mbox{---}" Harry said, and then shut his mouth. On second thought, no he was
...
rules are\mbox{---}" That didn't really work either, did it. "Okay, third try. I'm
...
looking for a \emph{specific} hint, it's for a game I'm playing\mbox{---}"
...
boys, "did `oo want the widdle books\mbox{---}"
...
it as pointless a disgrace to the name of Salazar Slytherin as it\mbox{---}"
...
"\emph{You,}" growled the largest Slytherin, "\emph{you, are, going, to}\mbox{---}"
...
threat in front of a dozen witnesses, you \emph{idiot}\mbox{---}"
...
Harry took out his wand. "What do I\mbox{---}"
...
\emph{that}. It's just, um, something the Sorting Hat told me\mbox{---}"
\looseness=1
...
hate me. This isn't about me trying to look cool by apologizing or your having
...
said again, his voice now hoarse. "It's just{\el} you looked so scared,
...
there wasn't so much to be afraid of\mbox{---}"
...
it was fun. So that's why I'm apologizing\mbox{---}"
...
\begin{center}
    ...
    Final instruction:\\
    \normalfont\emph{go to Professor McGonagall's office}
\end{center}
