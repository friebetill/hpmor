{
    \addtolength{\midchapskip}{-.5\baselineskip}
    \addtolength{\afterchapskip}{-.5\baselineskip}
...
those who have thrice defied him, born as the seventh month}\mbox{---}"
...
probably refers to my scientific background\mbox{---}"
...
"But\mbox{---}" Minerva blurted. "But the raid on Azkaban\mbox{---}"
...
Voldemort who removed them, I am sure\mbox{---}"
...
a shelf to show where it was\mbox{---}" The old wizard stopped. "But I suppose," the
...
increases the probability that \mbox{someone} attempted one. Which, in turn, raises
...
odds of twenty to one that the Dark Lord is dead\mbox{---}"
...
to obscure the exact shape---better yet, cover it with a layer of fake skin\mbox{---}"
...
"Well\mbox{---}" The boy stopped, frowning. "It seems unnecessarily complicated, more
...
you---\emph{take the Dark Lord seriously!} He is more dangerous than\mbox{---}" The
...
"But now\mbox{---}" Dean said sadly. "We \emph{can't} go back, can we? It'd be like
...
\emph{couldn't} fall in love\mbox{---}"
...
"You don't mean\mbox{---}" gasped Sarah.
...
"Not \emph{certain}\mbox{---}" Dumbledore began.
...
we're \emph{not} sure and you're heading off to kill him\mbox{---}"
...
voice\mbox{---}" A chill went through Harry's body, his wand twitching in his hand.
...
armrest. "I tried the Defense Professor first, but\mbox{---}" The boy grimaced.
...
Flitwick's own inventions---he's a champion duelist as well as a Charms
Master\mbox{---}"

"I know that, son."

"Sorry. Anyway, the Professor says he left the dueling circuit before he got a
...
"But\mbox{---}" said Professor McGonagall. She glanced at Mad-Eye Moody, who was
...
invisible, or put up shields\mbox{---}"
...
"Harry\mbox{---}" the Transfiguration Professor said, and then closed her mouth.
...
Her mind went blank, trying to imagine; her thoughts an empty \mbox{parchment}.
\looseness=1
