...
\glqq Expecto Patronum!\grqq{}, rief Harry.
...
Deine Zauberstabarbeit war genau richtig."
...
genug sind -" Harry versuchte nicht, etwas über das Familienmotto der Verres zu
erklären.
...
Harry ließ sich auf das kalte, tote Gras des Winters plumpsen, neben dem
...
Es war der Tag, an dem der Dementor nach Hogwarts kam. Zuvor hatte Harry den
...
\glqq Ein Otter\grqq{}, sagte Hermine sofort.
...
Vierzig Sekunden Dementoreinwirkung bei fünf Schritten hätten möglicherweise
...
Professor Quirrell war aufgetaucht, kurz nachdem die Erstklässler mit ihren
...
\glqq gräulich und schleimig... tot und eine Weile im Wasser gelegen... \glqq
...
\glqq Geh und iss etwas Schokolade, dann geht es dir besser." Seamus nickte und
...
Das... war etwas, das Harry normalerweise nicht gedacht hätte... \emph{Das ist
...
Alle Schüler sahen sie verwirrt an, außer Hermine, die in Richtung des Käfigs
...
\glqq Schulleiter?\grqq{} sagte Harry. \glqq Was sehen Sie?"
...
Harry wollte nicht zulassen, dass sein Verstand etwas Falsches sah, und so sah
...
<p style=\grqq{}.ext-align:center\grqq{}. \textbf{Und der Dementor schlug in
seinen Geist ein wie die Faust Gottes.}</p> <p
style=\grqq{}.ext-align:center\grqq{}. \textbf{ ANGST / KÄLTE/ DUNKELHEIT }</p>
...
Harrys Zauberstab kam im letzten Schwung hoch. <p
style=\grqq{}.ext-align:center\grqq{}. \textbf{\emph{ Es fühlte sich falsch
an.}} </p>
...
zu ihm kam, oder ein Bild von Mum und Dad, verdrehte der Dementor es, zeigte ihm
...
Männerstimme. \glqq \emph{Geh! Lauf! Ich werde ihn aufhalten!}"
...
(Der Zauberstab flog aus den nervenlosen Fingern des Jungen, als sein Körper zu
...
\glqq \emph{Nicht Harry! Bitte ... habt Erbarmen ... habt Erbarmen …}"
...
\glqq \emph{Nicht Harry, bitte nicht, nimm mich, töte mich lieber!}"
...
\emph{Avada ke-}" Die tödliche Stimme endete zuerst, der Fluch schnell und
präzise. \glqq \textbf{\emph{Avadakedavra.}}"

Ein grelles, grünes Aufblitzen markierte das Ende von Lily Potter. Und der Junge
...
Harry und den Dementor! Er nährt sich immer noch an ihm!}" Es gab einen Moment
...
Auf dem Gesicht von Albus Dumbledore lag eine furchtbare Agonie und
...
waren etwas mehr als zwanzig Sekunden."
