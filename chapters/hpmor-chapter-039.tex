\partchapter{Pretending to be Wise}{1}
...
usually acts{\el}" Harry trailed off. Why \emph{had} he put it that way?
...
Harry frowned. "Then I really don't see why you're sus\-pi\-cious\mbox{---}"
...
\emph{How much does he know\el\kern\ellipsisgapitalic?}
...
impressively cunning{\el} which had better not \emph{actually} get in the
way of Professor Quirrell's teaching Defense{\el}
...
not \emph{why}{\el}" For a time Dumbledore stared off into nothingness; then
...
wise, so young\el?" The old wizard sounded sad, as he said it. "Perhaps it
...
if so, there's this Muggle thing called a suicide prevention hotline\mbox{---}"
...
"Harry{\el}" The old wizard's voice was starting to sound a little helpless;
...
and that I'd begun to call them my mother and father\mbox{---}"
...
"Harry{\el}" the Headmaster said, starting to look rather worried. "I can
tell you the truth, but if you refuse to hear it{\el}"
...
disbelief may do to you{\el} so listen, then, Harry, please listen{\el}"
...
it drove him mad, and he killed himself to be truly with her once more{\el}
