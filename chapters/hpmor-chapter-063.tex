...
"I'm\mbox{---}" she said. "I'm only twelve, I haven't \emph{done} anything yet\mbox{---}"
...
Bellatrix Black had been taken from Azkaban\el?
...
fanatically devoted to a Dark Lord who wasn't around \mbox{anymore}?
\looseness=1
...
"I would've thought you'd be happy\mbox{---}"
...
"About Bellatrix Black?" said Draco. "Yeah\mbox{---}"
...
"\emph{What?}" said Draco. "Oh, there is just no \emph{way} that\mbox{---}"
...
"You don't \emph{really} think\mbox{---}" said Gregory.
...
"\emph{Quietus}," said Harry. "Draco, what\mbox{---}"
...
"If you're dealing with Father behind my back\mbox{---}"
...
\emph{can't}, I mean it \emph{can't possibly} be good. And, um{\el} people
are also saying{\el}"
...
There's got to be much more experienced Aurors tracking her\mbox{---}" \emph{oh, wait,
that's not good}---
...
she's kidding\mbox{---}" and Ron reached over to a plate and hefted a muffin---
...
speaking, "I\mbox{---}" \emph{didn't have anything to do with it,} he should have been
...
to ask you in front of Longbottom\mbox{---}"
\looseness=1
...
do not trust my cunning, and indeed I have shown myself a fool{\el} I only
...
and I will answer, my Lord\mbox{---}"
...
\emph{Would I cry?} wondered Harry. \emph{If I knew nothing, if I were innocent,
...
"\emph{Gah!}" said Moody. "That bloody sentimental fool\mbox{---}"
...
other substances! And where would \emph{we} even get\mbox{---}"
...
"Hold on," Moody said suddenly. "How do you know \emph{this} is really where\mbox{---}"
...
"How long did it take Albus to reali\mbox{---}"
...
slaughtering his family, and he cannot move the grave itself\mbox{---}"
...
The Headmaster of Hogwarts, the Chief Warlock of the \mbox{Wizengamot}, the Supreme
...
Harry did \emph{not}, in fact, think this; and after a moment's \mbox{reflection},
...
\emph{What did I see\el\kern\ellipsisgapitalic?}
...
saying you'd run off to \emph{join} Bellatrix Black\mbox{---}" and \emph{those} rumors
