...
Mr.~Crabbe and Mr.~Goyle looked \emph{very} unhappy. "Boss\mbox{---}" said Mr.~Crabbe.
...
right way and everyone in Ravenclaw \emph{knows that}\mbox{---}"
...
\emph{I} would never make when \emph{I} was a Dark Lord\mbox{---}"
...
the very first lessons you learn\mbox{---}"
...
Professor Quirrell walked back to his desk and resumed \mbox{leaning} on it.
...
spells that could defend him, but because \mbox{otherwise} (Harry thought) he might
...
A foot rested on Harry's buttocks and a moment later \mbox{Harry} was pushed hard to
