\abbrevnamedpartchapter{Self-Actualization}{SA}{Aftermaths}{Surface Appearances}
...
can do anything I want to him without ethical problems\mbox{---}"
...
trouble comes of it\mbox{---}" The boy shrugged. "Let Light win again."
...
exchange for a peace treaty, that they should fight right away\mbox{---}"
...
it would---the fabric of society\mbox{---}" Harry stopped. His thoughts weren't as
...
doves\mbox{---}"Don't you see, if evil people are willing to risk violence to get what
...
Harry would have liked to be allowed to tell Draco, but\mbox{---}"I swear," Harry said.
...
"What?" said the old wizard. "No! I would not have done that even to him\mbox{---}"
\sbreak
...
he has set out, and somewhat of how it is truly guarded\mbox{---}"
...
can\mbox{---}" A frantic, nerve-racking moment while he figured out how to say it
...
You \emph{helped} a \emph{Mudblood}\mbox{---}"
...
how the others stayed silent when you were in need\mbox{---}"
...
\emph{on?} "That's\mbox{---}" Hermione said. Her voice was quavering. "That's
...
"Time\mbox{---}" The voice seemed to catch itself. "Time enough for that later. For
...
that much! Tell me, and then\mbox{---}" The voice caught, and came back quieter. "And
then you can go, I suppose. Only tell me---\emph{why}\mbox{---}"
