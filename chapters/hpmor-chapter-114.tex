\partchapter{Shut Up and Do The Impossible}{1}
...
\parsel{"Time'ss almosst up\mbox{---}"} hissed Voldemort.
...
\parsel{"Now sspeak a ssecret,"} the Dark Lord hissed, \parsel{"or I\mbox{---}"}
...
\parsel{"Thiss iss sstarting to become ssad{\el}"} the Dark Lord's voice
...
by the \mbox{extended} line of spider-silk was something Harry could Transfigure
