...
"This\mbox{---}" Professor Quirrell said, and coughed, it didn't sound quite right.
"This is a fascinating book{\el} if I'd ever realized{\el}" A laugh,
mixed with another cough. "Why did I assume the Muggle arts{\el} must not be
mine? That they would be{\el} of no use to me? Why did I never bother
trying{\el} to test it experimentally{\el} as you would say? In
case{\el} my assumption{\el} was wrong? It seems sheerly foolish of
me{\el} in retrospect{\el}"
...
"There is{\el} \parsel{there iss a ritual, I heard of from the sschoolmasster,
by which he thinkss the Dark Lord might have lived on. It iss called}\mbox{---}"and
Harry stopped, as he realized that he did know how to say the word in
Parseltongue. \parsel{"Horcrux. It requiress a death, I have heard. But if you
...
though I don't ssee how that could be true\mbox{---}"}
...
The burning sensation was back in Harry's throat. \parsel{"No continuity of\mbox{---}"}
...
which might also improve the fidelity of the personality transfer{\el}
though that still left the other problems.

Professor Quirrell made a short sound, under his breath, that might have been
laughter. "You know, boy," Professor Quirrell whispered, "I had thought{\el}
to teach you everything{\el} the seeds of all the secrets I knew{\el}
from one living mind to another{\el} so that later, when you found the right
books, you would be able to understand{\el} I would have passed on my
knowledge to you, my heir{\el} we would have begun as soon as you asked
me{\el} but you never asked."
...
Another coughing chuckle. "Ah yes{\el} the unknowing Muggleborn{\el} in
heritage if not in blood{\el} that is you. But I thought{\el} better of
it{\el} that you should not walk my path{\el} it was not a good path, in
the end."
...
"Yes, it is too late{\el} and you shall not{\el} persuade me
otherwise{\el} I have{\el} thought better of it{\el} as I said{\el}
I am too full{\el} of secrets better left unknown{\el} \emph{look at me.}"
...
"You see," whispered the Professor. "I dislike to sound cliched{\el}
...
know how long{\el} I shall be able to \mbox{converse}."
\looseness=1
...
see{\el}" A pause of transformation. \parsel{"I did not wissh guard dead,
...
life, over your death, Professor \mbox{Quirrell}."
\looseness=1
...
\parsel{"Could assk sschoolmasster\mbox{---}"}

\parsel{"No! Do not assk him, boy. He would not take quesstion well."}

\parsel{"But if the Sstone only healss\mbox{---}"}
...
A man lay on the bed once more. "I am at{\el} my limit{\el}" said
Professor Quirrell. "I must regain{\el} my strength{\el} before I
go{\el} to the forest{\el} with your gift. Leave now{\el} but sustain
the Transfiguration{\el} before you go."
