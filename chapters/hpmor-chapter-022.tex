...
Harry war jetzt besser im Unterricht, zumindest in den Klassen, die er für
...
\glqq{}Was hast du dieses Mal verändert?\grqq{} sagte Hermine und klang ein
wenig müde.
...
Aber (so hatte Harry argumentiert) es musste nicht so sein, es war nicht in das
...
Heutzutage nannte man das \glqq{}\emph{blenden}\grqq{} und es war eines der
...
Draco Malfoy war sich nicht sicher gewesen, ob er sich darauf freuen sollte oder
nicht.
...
Das hatte Draco wirklich nicht. Niemals. Idioten zu gefallen war wie atmen, man
...
hatte sicher jemand Papa berichtet, dass er Harry Potter den Hof machte, und
Papa würde auch wissen, dass Draco nicht nach Hause geschrieben hatte, und
Papa würde verstehen, dass Draco nicht glaubte, es wirklich geheim halten zu
...
Daraus folgte, dass Papa wahrscheinlich vorausgesehen hatte, was Draco als
nächstes sagen würde.

Das Spiel mit Papa in echt zu spielen, war ein ziemlich zermürbendes Gefühl.
...
Papa das Spiel besser gespielt hatte. Anders konnte es gar nicht laufen.

\glqq{}Harry\grqq{}, sagte Draco schließlich. \glqq{}Das ist kein Vorschlag. Das
ist kein Ratschlag von mir. Es ist einfach so, wie es ist. Mein Papa könnte
diesen Artikel mit ziemlicher Sicherheit unterdrücken. Aber es würde dich etwas
kosten.\grqq{}

Dass Papa erwartet hatte, dass Draco Harry Potter genau das sagen würde, sprach
...
auch immer Harry Potter als Nächstes vorhatte, es würde etwas sein, womit Papa
...
Dann ließ Harry Potter den Zauberstab sinken, obwohl seine Hand ein wenig
zittrig wirkte, und steckte ihn zurück in seinen Umhang.

Der ganze Raum schien spürbar kühler zu werden. Das hätte Draco auch tun können,
\emph{aber trotzdem, nicht schlecht.}

\glqq{}Also\grqq{}, sagte Draco. \glqq{}Wissenschaft. Du wirst mir etwas über
Blut erzählen.\grqq{}

\glqq{}Wir werden etwas über Blut herausfinden\grqq{}, sagte Harry Potter.
\glqq{} Indem wir Experimente machen.\grqq{}
...
sehr oft angewendet. Es war lästig gewesen, aber effektiv.

Dann gab es noch die Potter-Methode, die wahnsinnig war.

Um fair zu sein, musste Draco zugeben, dass Harry Potter die sokratische Methode
zuerst ausprobiert hatte und sie nicht besonders gut funktioniert hatte.

Harry Potter hatte gefragt, wie Draco die Hypothese der Blutpuristen widerlegen
...
Squibs gekreuzt hätten.

Draco hatte gesagt, dass er nicht verstehe, wie Harry Potter mit geradem Gesicht
dasitzen und behaupten könne, dies sei keine Falle.
...
ehrlichen Versuch unternahm und scheiterte, war das ein Sieg.

Draco hatte versucht, auf die umwerfende Dummheit dieses Vorgehens hinzuweisen,
...
sie ihr Blut mit Schlamm vermischten. Es war zu offensichtlich wahr.

Da hatte Harry Potter ziemlich frustriert gesagt, dass er sich nicht vorstellen
könne, dass Draco wirklich so schlecht darin sei, andere Standpunkte in Betracht
zu ziehen, es habe doch sicher Todesser gegeben, die sich als Feinde des
...
hätte er niemanden auch nur eine Sekunde lang getäuscht.

Draco war gezwungen gewesen, zuzugeben, dass das ein Argument war.

\emph{Daher auch die Potter-Methode.}

\glqq{}Bitte, Dr. Malfoy\grqq{}, jammerte Harry Potter, \glqq{}warum wollen Sie
meine Arbeit nicht annehmen?\grqq{}

Harry Potter hatte den Satz \emph{\glqq{}Tu einfach so, als wärst du ein
Todesser der so tut als wäre er ein Wissenschaftler\grqq{}} dreimal wiederholen
müssen, bevor Draco es verstanden hatte.

In diesem Moment hatte Draco erkannt, dass mit Harry Potters Gehirn etwas
zutiefst verkehrt war, und jeder, der Legilimenz daran ausprobierte, würde
wahrscheinlich nie wieder herauskommen. Harry Potter war dann in weitere und
erhebliche Details gegangen: Draco sollte sich als Todesser ausgeben, der sich
als Herausgeber einer wissenschaftlichen Zeitschrift, Dr. Malfoy, ausgab, der
die Abhandlung seines Feindes Dr. Potter \emph{\glqq{}Über die Vererbbarkeit
magischer Fähigkeiten\grqq{}} ablehnen wollte, und wenn der Todesser sich nicht
so verhielte, wie es ein echter Wissenschaftler tun würde, würde er als Todesser
enttarnt und hingerichtet werden, während Dr. Malfoy auch von seinen eigenen
Rivalen beobachtet wurde und er musste den Anschein erwecken, dass er Dr.
Potters Aufsatz aus neutralen wissenschaftlichen Gründen ablehnte, sonst würde
er seine Position als Herausgeber der Zeitschrift verlieren.

Es war ein Wunder, dass der Sortierhut in St. Mungo's nicht wie verrückt
klapperte.

Es war auch die komplizierteste Sache, um die Draco jemals gebeten worden war,
und es gab keine Möglichkeit, dass er die Herausforderung hätte ablehnen können.

Gerade jetzt waren sie, wie Harry Potter es ausgedrückt hatte, dabei in Stimmung
zu kommen.
...
\glqq{}Dann wird es zu kurz. Der Nächste!\grqq{}
...
\glqq{}Sie, ähm, müssen andere mögliche Erklärungen für Ihre, ähm, Beobachtung
...
Dracos Atem blieb ihm im Hals stecken. Sein Papa hatte in seinen Reden oft
...
Das könnte jedem passieren. Es würde keine Zauberer mehr geben, keine Magie
...
ist. Jetzt verstand Draco, er wusste, warum Papa und Vaters Freunde geschworen
...
Ausdruck. \glqq{}Hat dir dein Papa nie gesagt, dass das Leben nicht fair
ist?\grqq{}

Papa hatte das jedes Mal gesagt, wenn Draco das Wort benutzte. \glqq{}Aber,
...
\glqq{}Was wahr ist, ist schon so\grqq{}, wiederholte Draco mit zitternder
...
\glqq{}Es wird wirklich schwer sein, zwischen zwei und sechs zu
...
Dracos Gesicht verfinsterte sich, als er versuchte, sich zu erinnern. \glqq{}Ich
...
Draco setzte sich wieder hin und kramte in seiner Büchertasche nach Pergament
