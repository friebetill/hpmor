\abbrevnamedpartchapter{The Stanford Prison Experiment}{TSPE}{8}{Constrained Cognition}
...
hide in, wearing the Cloak, while \mbox{Harry} turned himself in. And Professor
...
It seemed very{\el} \emph{inviting,} that two-meter hole leading to freedom.
...
\parsel{"What wass{\el} that noisse?"}
\sbreak
...
shoulders, was slowly lifting its head to look around. \parsel{"Are you{\el}
all right, teacher?"}
...
your killing cursse, there was a ressonance between uss{\el} you fell
unconssciouss, I had to defeat the protector man mysself{\el} my guardian
...
probably the sschoolmasster{\el} so had to disspell my guardian Charm, find
...
for a deeper examination{\el} well, Harry had acted heroically throughout.
...
only yourss and herss. Sso I am sstaying, turning mysself in\mbox{---}"}
...
life-eaterss. Musst russh, ssomeone may have heard noisse\mbox{---}"}
