\partchapter{Self Actualization}{3}
...
just---if I'd only figured out he was wearing armor\mbox{---}"
...
battle. The world around us explodes with
...
Lieutenant, to be divided among Dragon Army and the Sunshine Regiment\mbox{---}"
...
"\emph{Professor Quirrell!}" said Harry. "I didn't\mbox{---}"
...
"That\mbox{---}" Harry's voice said urgently, she wasn't looking at him but his voice
...
whole bunch of tricks I'd been saving up---and\mbox{---}"
...
{\el} of course it was. She couldn't even \emph{look} Harry in the eyes when
...
yet, "\emph{I} shouldn't have to fight your dark side, I'm just---I'm only\mbox{---}"
...
"I\mbox{---}" Harry said. His voice got a little lower, "I wasn't{\el} really
\emph{expecting} to win, that time, I know I said I was invincible but that was
just to try to scare you, I really just thought we'd slow you down for a bit\mbox{---}"
...
only through established Charms; and sometimes{\el} they didn't.
...
ever worried or uncomfortable about anything, I should come to you at once\mbox{---}"
...
Quirrell had praised General Malfoy for not \mbox{ignoring} his thousand alternatives;
...
looking like it had drawers set \emph{inside} other \mbox{drawers}, was the
...
she spoke. "That is{\el} unfortunate, but I cannot say it is unexpected.
...
"I\mbox{---}" said Hermione. "I'm not sure---I still want to be\mbox{---}" Her voice stopped,
...
around him and{\el}" She didn't have the words.
...
Hermione shook her head rapidly. "But that's \emph{not}\mbox{---}" She'd known she
...
mistaken{\el} Miss Granger, you have no idea at \emph{all} how fortunate are
...
to live inside someone else's shadow like that{\el}"
...
And if you are asking me for a quest\mbox{---}" The old wizard smiled again, rather
...
"I'll," she said, her voice stuck, "I'll, I'll\mbox{---}"

She swallowed.

"I'll do---what's right\mbox{---}"
...
\emph{she} was about to burst into tears{\el} only not really, but there was
