...
\newcommand{\CoverAuthor}{\UnsetValue}% Set cover author here, to appear in colophon
\newcommand{\PdfSourceUrl}{\UnsetValue}% Set URL for the book's source code, to appear in colophon
